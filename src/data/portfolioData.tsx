...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: "A resort booking platform with dynamic filtering for room types, capacity, and pricing.",
    technologies: ["React", "React Router", "Contentful", "Styled Components", "JavaScript", "HTML", "CSS"],
    highlights: [
  ...
  },
  {
    ...
    description: "A YouTube video search and player app with real-time search using YouTube Data API.",
    technologies: ["React", "YouTube Data API", "Axios", "JavaScript", "HTML", "CSS Modules"],
    highlights: [
  ...
  },
  {
    ...
    description: "A Pokémon explorer app that displays Pokémon images and stats using PokéAPI.",
    technologies: ["React", "PokéAPI", "JavaScript", "React Hooks", "HTML", "CSS"],
    highlights: [
  ...
  },
  {
    ...
    description: "A simple dog image gallery using a public Dog API to fetch and display random breeds.",
  ...
  },
  {
    ...
    description: "Machine learning experiments with data classification and clustering on sample datasets.",
    technologies: ["Python", "scikit-learn", "Pandas", "NumPy", "Matplotlib", "Jupyter Notebooks"],
    highlights: [
  ...
  },
  {
    ...
    description: "Web scraping and text mining project analyzing online articles using NLP techniques.",
    technologies: ["Python", "BeautifulSoup", "scikit-learn", "NLTK", "Pandas", "Matplotlib"],
    highlights: [
  ...
  },
  {
    ...
    description: "A glowing neon-style animated text effect using HTML and CSS only.",
...
export const skills: SkillCategory = {
  ...
  "Frontend Development": ["React.js", "Redux", "Material-UI", "HTML5", "CSS3/SASS", "Tailwind CSS", "Bootstrap", "D3.js", "Webpack"],
  "Backend Development": ["Node.js", "Express.js", "REST APIs", "GraphQL"],
  "Database Systems": ["PostgreSQL", "MySQL", "Redis", "MongoDB"],
  "DevOps & Hosting": ["Google Cloud Platform (GCP)", "AWS (Familarity)", "Firebase Hosting", "Netlify", "Docker", "GitHub Actions"],
  "Testing": ["Jest", "Cypress", "Mocha", "Chai", "React Testing Library", "Postman"],
  "Tools & Workflows": ["Git", "GitHub", "Bitbucket", "Agile", "CI/CD", "ESLint", "Prettier", "VS Code"],
};
