...
export const ActionButton: React.FC<ActionButtonProps> = ({
  ...
  const variants = {
    ...
    secondary: `
      ...
      ${
        isLinkedIn
          ? 'hover:border-blue-400 hover:bg-blue-500/10 hover:text-blue-200 before:bg-blue-500/5'
          : isGitHub
            ? 'hover:border-purple-400 hover:bg-purple-500/10 hover:text-purple-200 before:bg-purple-500/5'
  ...
  return (
    ...
    >
      ...
      {!isIconOnly && <span className='z-10 relative'>{children}</span>}
