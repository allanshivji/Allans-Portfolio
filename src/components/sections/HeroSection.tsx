  ...
  return (
    ...
    >
      ...
      >
        {/* Profile Photo */}
        <div
          className={`mb-8 mt-8 transition-all duration-1000 ${showContent ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
        >
        ...
        >
          <p className='text-lg sm:text-xl md:text-2xl text-white/60 max-w-3xl mx-auto leading-relaxed'>
            Crafting scalable applications with modern technologies. Passionate
            about creating exceptional user experiences and robust backend
            systems.
          </p>
        </div>
