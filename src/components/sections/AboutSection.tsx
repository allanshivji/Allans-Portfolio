          ...
          <AnimatedSection delay={200}>
            <div className='space-y-6'>
              <p className='text-2xl text-white/80 leading-relaxed'>
                ...
                experience building scalable applications that serve thousands
                of users in the healthcare and agricultural technology sectors.
              </p>
              <p className='text-lg text-white/60 leading-relaxed'>
                My expertise spans modern web technologies including React,
                TypeScript, Node.js, and cloud platforms. I believe in writing
